...
const Theme = () => {
  return (
    <Modal className="theme__modal">
      ...
      <div className="theme__backgraound-wrapper">
        <h5>Background Color</h5>
		<div className="theme__bacground-colors">
			{
				backgroundColors.map(bColor => <BackgroundColor key={bColor} className={bColor.className}/>)
			}
		</div>
      </div>
    </Modal>
